...
exports.exportFinanceData = exports.getTransactions = exports.rejectWithdrawal = exports.approveWithdrawal = exports.getWithdrawals = exports.getPayments = exports.getFinanceStats = void 0;
...
const getFinanceStats = async (req, res) => {
    try {
        ...
        // 실제 지급된 리워드 (출금 완료)
        const completedRewards = await database_1.prisma.reward.aggregate({
            where: {
                status: 'PAID',
                ...dateFilter
            },
        ...
        const completedResponses = await database_1.prisma.surveyResponse.findMany({
            where: {
...
const getTransactions = async (req, res) => {
    try {
        const period = req.query.period || 'month';
        const status = req.query.status || 'all';
        const type = req.query.type || 'all'; // 'DEPOSIT', 'WITHDRAWAL', 'all'
        const startDate = req.query.startDate;
        const endDate = req.query.endDate;
        const dateFilter = getDateFilter(period, startDate, endDate);
        const transactions = [];
