...
exports.requestSurveyCancellation = exports.extendSurvey = exports.getTemplate = exports.getSurveyResponses = exports.updateSurvey = exports.debugTemplates = exports.getTemplates = exports.getSurvey = exports.getSurveys = exports.createSurvey = exports.createSurveyValidation = void 0;
...
const debugTemplates = async (req, res) => {
    try {
        ...
        // 데이터베이스 연결 상태 확인
        try {
            const connectionTest = await database_1.prisma.$queryRaw `SELECT 1 as test`;
        ...
        let templates;
        try {
            templates = await database_1.prisma.surveyTemplate.findMany({
                select: {
                    id: true,
                    name: true,
                    description: true,
